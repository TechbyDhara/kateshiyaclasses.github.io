...
<td>
<a href="edit_contact.php?id=<?php echo $row['id']; ?>" class="edit-btn">
<i class="fa-solid fa-pen-to-square"></i>
</a>
<a href="contacts.php?id=<?php echo $row['id']; ?>" class="delete-btn">
...
if(isset($_GET['id'])) {
$id = $_GET['id'];
mysqli_query($conn,"DELETE FROM contactus WHERE id='$id'");
}
?>